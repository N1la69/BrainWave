        ...
        <div className="relative">
          ...
          <div className="relative z-1 grid lg:grid-cols-2 gap-5">
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col justify-end bg-gradient-to-b p-8 from-n-8/0 to-n-8/90 lg:p-15">
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
                    ...
                    <li
                      className={`flex items-center justify-center rounded-2xl ${
                        index === 2
                          ...
                          : "flex bg-n-6 w-10 h-10 md:w-15 md:h-15"
                      }`}
                      key={index}
                    >
              ...
              <div className="relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]">
                <img src={service3} alt="ser3" className="w-full h-full object-cover" width={520} height={400}/>
                <VideoChatMessage />
                <VideoBar />
              </div>
            </div>
